...
#define LLE_PERF_TARGET_RESPONSE_TIME_NS 500000ULL /// 500micros
#define LLE_PERF_MONITORING_OVERHEAD_NS 10000ULL   /// 10micros
...
#define LLE_PROFILER_HOT_SPOT_THRESHOLD_NS 100000ULL       /// 100micros

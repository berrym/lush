...
#define LLE_PERF_MAX_RESPONSE_TIME_NS 500000ULL    /// 500mus
#define LLE_PERF_MAX_ALLOCATION_TIME_NS 100000ULL  /// 100mus
#define LLE_PERF_MAX_RENDER_TIME_NS 1000000ULL     /// 1ms
#define LLE_PERF_MAX_EVENT_PROCESSING_NS 250000ULL /// 250mus

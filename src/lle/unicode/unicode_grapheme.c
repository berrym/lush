...
static grapheme_cluster_break_t lle_get_gcb_property(uint32_t codepoint) {
    ...
    if ((codepoint <= 0x001F && codepoint != 0x000A &&
        ...
        (codepoint >= 0xFFF9 &&
         codepoint <= 0xFFFB) || /// Annotation characters
        (codepoint >= 0x1BCA0 &&
    ...
    if ((codepoint >= 0x0903 && codepoint <= 0x0903) || /// Devanagari visarga
        ...
        (codepoint >= 0x0D02 &&
         codepoint <= 0x0D03) || /// Malayalam vowel signs
        (codepoint >= 0x0D3F &&
         codepoint <= 0x0D40) || /// Malayalam vowel signs
        (codepoint >= 0x0D46 &&
         codepoint <= 0x0D48) || /// Malayalam vowel signs
        (codepoint >= 0x0D4A &&
         codepoint <= 0x0D4C)) { /// Malayalam vowel signs
    ...
    if ((codepoint >= 0x0300 &&
        ...
        (codepoint >= 0x302A &&
         codepoint <= 0x302D) || /// Ideographic combining
        ...
        (codepoint >= 0x11C30 &&
         codepoint <= 0x11C36) || /// Bhaiksuki combining
        ...
        (codepoint >= 0x16AF0 &&
         codepoint <= 0x16AF4) || /// Bassa Vah combining
        (codepoint >= 0x16B30 &&
    ...
    if ((codepoint >= 0x1F300 &&
        ...
        (codepoint >= 0x2600 &&
         codepoint <= 0x2604) || /// Miscellaneous symbols
        codepoint == 0x260E ||
        codepoint == 0x2611 || (codepoint >= 0x2614 && codepoint <= 0x2615) ||
        codepoint == 0x2618 || codepoint == 0x261D || codepoint == 0x2620 ||

...
static const decomposition_entry_t decomposition_table[] = {
    ...
    {0x00C0, 0x0041, 0x0300}, /// A-grave = A + grave
    {0x00C1, 0x0041, 0x0301}, /// U+00C1 = A + acute
    {0x00C2, 0x0041, 0x0302}, /// U+00C2 = A + circumflex
    {0x00C3, 0x0041, 0x0303}, /// U+00C3 = A + tilde
    {0x00C4, 0x0041, 0x0308}, /// U+00C4 = A + diaeresis
    {0x00C5, 0x0041, 0x030A}, /// U+00C5 = A + ring above
    {0x00C7, 0x0043, 0x0327}, /// U+00C7 = C + cedilla
    {0x00C8, 0x0045, 0x0300}, /// U+00C8 = E + grave
    {0x00C9, 0x0045, 0x0301}, /// E-acute = E + acute
    {0x00CA, 0x0045, 0x0302}, /// U+00CA = E + circumflex
    {0x00CB, 0x0045, 0x0308}, /// U+00CB = E + diaeresis
    {0x00CC, 0x0049, 0x0300}, /// U+00CC = I + grave
    {0x00CD, 0x0049, 0x0301}, /// U+00CD = I + acute
    {0x00CE, 0x0049, 0x0302}, /// U+00CE = I + circumflex
    {0x00CF, 0x0049, 0x0308}, /// U+00CF = I + diaeresis
    {0x00D1, 0x004E, 0x0303}, /// U+00D1 = N + tilde
    {0x00D2, 0x004F, 0x0300}, /// U+00D2 = O + grave
    {0x00D3, 0x004F, 0x0301}, /// U+00D3 = O + acute
    {0x00D4, 0x004F, 0x0302}, /// U+00D4 = O + circumflex
    {0x00D5, 0x004F, 0x0303}, /// U+00D5 = O + tilde
    {0x00D6, 0x004F, 0x0308}, /// U+00D6 = O + diaeresis
    {0x00D9, 0x0055, 0x0300}, /// U+00D9 = U + grave
    {0x00DA, 0x0055, 0x0301}, /// U+00DA = U + acute
    {0x00DB, 0x0055, 0x0302}, /// U+00DB = U + circumflex
    {0x00DC, 0x0055, 0x0308}, /// U+00DC = U + diaeresis
    {0x00DD, 0x0059, 0x0301}, /// U+00DD = Y + acute
    {0x00E0, 0x0061, 0x0300}, /// a-grave = a + grave
    {0x00E1, 0x0061, 0x0301}, /// U+00E1 = a + acute
    {0x00E2, 0x0061, 0x0302}, /// U+00E2 = a + circumflex
    {0x00E3, 0x0061, 0x0303}, /// U+00E3 = a + tilde
    {0x00E4, 0x0061, 0x0308}, /// a-umlaut = a + diaeresis
    {0x00E5, 0x0061, 0x030A}, /// U+00E5 = a + ring above
    {0x00E7, 0x0063, 0x0327}, /// c-cedilla = c + cedilla
    {0x00E8, 0x0065, 0x0300}, /// e-grave = e + grave
    {0x00E9, 0x0065, 0x0301}, /// e-acute = e + acute
    {0x00EA, 0x0065, 0x0302}, /// U+00EA = e + circumflex
    {0x00EB, 0x0065, 0x0308}, /// U+00EB = e + diaeresis
    {0x00EC, 0x0069, 0x0300}, /// U+00EC = i + grave
    {0x00ED, 0x0069, 0x0301}, /// U+00ED = i + acute
    {0x00EE, 0x0069, 0x0302}, /// U+00EE = i + circumflex
    {0x00EF, 0x0069, 0x0308}, /// i-umlaut = i + diaeresis
    {0x00F1, 0x006E, 0x0303}, /// n-tilde = n + tilde
    {0x00F2, 0x006F, 0x0300}, /// U+00F2 = o + grave
    {0x00F3, 0x006F, 0x0301}, /// U+00F3 = o + acute
    {0x00F4, 0x006F, 0x0302}, /// U+00F4 = o + circumflex
    {0x00F5, 0x006F, 0x0303}, /// U+00F5 = o + tilde
    {0x00F6, 0x006F, 0x0308}, /// o-umlaut = o + diaeresis
    {0x00F9, 0x0075, 0x0300}, /// U+00F9 = u + grave
    {0x00FA, 0x0075, 0x0301}, /// U+00FA = u + acute
    {0x00FB, 0x0075, 0x0302}, /// U+00FB = u + circumflex
    {0x00FC, 0x0075, 0x0308}, /// u-umlaut = u + diaeresis
    {0x00FD, 0x0079, 0x0301}, /// U+00FD = y + acute
    {0x00FF, 0x0079, 0x0308}, /// y-umlaut = y + diaeresis

    /// Latin Extended-A
    {0x0100, 0x0041, 0x0304}, /// U+0100 = A + macron
    {0x0101, 0x0061, 0x0304}, /// U+0101 = a + macron
    {0x0102, 0x0041, 0x0306}, /// U+0102 = A + breve
    {0x0103, 0x0061, 0x0306}, /// U+0103 = a + breve
    {0x0104, 0x0041, 0x0328}, /// U+0104 = A + ogonek
    {0x0105, 0x0061, 0x0328}, /// U+0105 = a + ogonek
    {0x0106, 0x0043, 0x0301}, /// U+0106 = C + acute
    {0x0107, 0x0063, 0x0301}, /// U+0107 = c + acute
    {0x0108, 0x0043, 0x0302}, /// U+0108 = C + circumflex
    {0x0109, 0x0063, 0x0302}, /// U+0109 = c + circumflex
    {0x010A, 0x0043, 0x0307}, /// U+010A = C + dot above
    {0x010B, 0x0063, 0x0307}, /// U+010B = c + dot above
    {0x010C, 0x0043, 0x030C}, /// U+010C = C + caron
    {0x010D, 0x0063, 0x030C}, /// U+010D = c + caron
    {0x010E, 0x0044, 0x030C}, /// U+010E = D + caron
    {0x010F, 0x0064, 0x030C}, /// U+010F = d + caron
    {0x0112, 0x0045, 0x0304}, /// U+0112 = E + macron
    {0x0113, 0x0065, 0x0304}, /// U+0113 = e + macron
    {0x0114, 0x0045, 0x0306}, /// U+0114 = E + breve
    {0x0115, 0x0065, 0x0306}, /// U+0115 = e + breve
    {0x0116, 0x0045, 0x0307}, /// U+0116 = E + dot above
    {0x0117, 0x0065, 0x0307}, /// U+0117 = e + dot above
    {0x0118, 0x0045, 0x0328}, /// U+0118 = E + ogonek
    {0x0119, 0x0065, 0x0328}, /// U+0119 = e + ogonek
    {0x011A, 0x0045, 0x030C}, /// U+011A = E + caron
    {0x011B, 0x0065, 0x030C}, /// U+011B = e + caron
    {0x011C, 0x0047, 0x0302}, /// U+011C = G + circumflex
    {0x011D, 0x0067, 0x0302}, /// U+011D = g + circumflex
    {0x011E, 0x0047, 0x0306}, /// U+011E = G + breve
    {0x011F, 0x0067, 0x0306}, /// U+011F = g + breve
    {0x0120, 0x0047, 0x0307}, /// U+0120 = G + dot above
    {0x0121, 0x0067, 0x0307}, /// U+0121 = g + dot above
    {0x0122, 0x0047, 0x0327}, /// U+0122 = G + cedilla
    {0x0123, 0x0067, 0x0327}, /// U+0123 = g + cedilla
    {0x0124, 0x0048, 0x0302}, /// U+0124 = H + circumflex
    {0x0125, 0x0068, 0x0302}, /// U+0125 = h + circumflex
    {0x0128, 0x0049, 0x0303}, /// U+0128 = I + tilde
    {0x0129, 0x0069, 0x0303}, /// U+0129 = i + tilde
    {0x012A, 0x0049, 0x0304}, /// U+012A = I + macron
    {0x012B, 0x0069, 0x0304}, /// U+012B = i + macron
    {0x012C, 0x0049, 0x0306}, /// U+012C = I + breve
    {0x012D, 0x0069, 0x0306}, /// U+012D = i + breve
    {0x012E, 0x0049, 0x0328}, /// U+012E = I + ogonek
    {0x012F, 0x0069, 0x0328}, /// U+012F = i + ogonek
    {0x0130, 0x0049, 0x0307}, /// U+0130 = I + dot above
    {0x0134, 0x004A, 0x0302}, /// U+0134 = J + circumflex
    {0x0135, 0x006A, 0x0302}, /// U+0135 = j + circumflex
    {0x0136, 0x004B, 0x0327}, /// U+0136 = K + cedilla
    {0x0137, 0x006B, 0x0327}, /// U+0137 = k + cedilla
    {0x0139, 0x004C, 0x0301}, /// U+0139 = L + acute
    {0x013A, 0x006C, 0x0301}, /// U+013A = l + acute
    {0x013B, 0x004C, 0x0327}, /// U+013B = L + cedilla
    {0x013C, 0x006C, 0x0327}, /// U+013C = l + cedilla
    {0x013D, 0x004C, 0x030C}, /// U+013D = L + caron
    {0x013E, 0x006C, 0x030C}, /// U+013E = l + caron
    {0x0143, 0x004E, 0x0301}, /// U+0143 = N + acute
    {0x0144, 0x006E, 0x0301}, /// U+0144 = n + acute
    {0x0145, 0x004E, 0x0327}, /// U+0145 = N + cedilla
    {0x0146, 0x006E, 0x0327}, /// U+0146 = n + cedilla
    {0x0147, 0x004E, 0x030C}, /// U+0147 = N + caron
    {0x0148, 0x006E, 0x030C}, /// U+0148 = n + caron
    {0x014C, 0x004F, 0x0304}, /// U+014C = O + macron
    {0x014D, 0x006F, 0x0304}, /// U+014D = o + macron
    {0x014E, 0x004F, 0x0306}, /// U+014E = O + breve
    {0x014F, 0x006F, 0x0306}, /// U+014F = o + breve
    {0x0150, 0x004F, 0x030B}, /// U+0150 = O + double acute
    {0x0151, 0x006F, 0x030B}, /// U+0151 = o + double acute
    {0x0154, 0x0052, 0x0301}, /// U+0154 = R + acute
    {0x0155, 0x0072, 0x0301}, /// U+0155 = r + acute
    {0x0156, 0x0052, 0x0327}, /// U+0156 = R + cedilla
    {0x0157, 0x0072, 0x0327}, /// U+0157 = r + cedilla
    {0x0158, 0x0052, 0x030C}, /// U+0158 = R + caron
    {0x0159, 0x0072, 0x030C}, /// U+0159 = r + caron
    {0x015A, 0x0053, 0x0301}, /// U+015A = S + acute
    {0x015B, 0x0073, 0x0301}, /// U+015B = s + acute
    {0x015C, 0x0053, 0x0302}, /// U+015C = S + circumflex
    {0x015D, 0x0073, 0x0302}, /// U+015D = s + circumflex
    {0x015E, 0x0053, 0x0327}, /// U+015E = S + cedilla
    {0x015F, 0x0073, 0x0327}, /// U+015F = s + cedilla
    {0x0160, 0x0053, 0x030C}, /// U+0160 = S + caron
    {0x0161, 0x0073, 0x030C}, /// U+0161 = s + caron
    {0x0162, 0x0054, 0x0327}, /// U+0162 = T + cedilla
    {0x0163, 0x0074, 0x0327}, /// U+0163 = t + cedilla
    {0x0164, 0x0054, 0x030C}, /// U+0164 = T + caron
    {0x0165, 0x0074, 0x030C}, /// U+0165 = t + caron
    {0x0168, 0x0055, 0x0303}, /// U+0168 = U + tilde
    {0x0169, 0x0075, 0x0303}, /// U+0169 = u + tilde
    {0x016A, 0x0055, 0x0304}, /// U+016A = U + macron
    {0x016B, 0x0075, 0x0304}, /// U+016B = u + macron
    {0x016C, 0x0055, 0x0306}, /// U+016C = U + breve
    {0x016D, 0x0075, 0x0306}, /// U+016D = u + breve
    {0x016E, 0x0055, 0x030A}, /// U+016E = U + ring above
    {0x016F, 0x0075, 0x030A}, /// U+016F = u + ring above
    {0x0170, 0x0055, 0x030B}, /// U+0170 = U + double acute
    {0x0171, 0x0075, 0x030B}, /// U+0171 = u + double acute
    {0x0172, 0x0055, 0x0328}, /// U+0172 = U + ogonek
    {0x0173, 0x0075, 0x0328}, /// U+0173 = u + ogonek
    {0x0174, 0x0057, 0x0302}, /// U+0174 = W + circumflex
    {0x0175, 0x0077, 0x0302}, /// U+0175 = w + circumflex
    {0x0176, 0x0059, 0x0302}, /// U+0176 = Y + circumflex
    {0x0177, 0x0079, 0x0302}, /// U+0177 = y + circumflex
    {0x0178, 0x0059, 0x0308}, /// U+0178 = Y + diaeresis
    {0x0179, 0x005A, 0x0301}, /// U+0179 = Z + acute
    {0x017A, 0x007A, 0x0301}, /// U+017A = z + acute
    {0x017B, 0x005A, 0x0307}, /// U+017B = Z + dot above
    {0x017C, 0x007A, 0x0307}, /// U+017C = z + dot above
    {0x017D, 0x005A, 0x030C}, /// U+017D = Z + caron
    {0x017E, 0x007A, 0x030C}, /// U+017E = z + caron
};

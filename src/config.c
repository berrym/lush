...
/// Autosuggestion Dismiss Policy mappings
static const config_enum_mapping_t autosuggestion_dismiss_policy_mappings[] = {
    {    "on_deviation",     AUTOSUGGESTION_DISMISS_ON_DEVIATION},
    {"on_word_boundary", AUTOSUGGESTION_DISMISS_ON_WORD_BOUNDARY},
    {              NULL,                                       0}  /// Sentinel
};
static const config_enum_def_t autosuggestion_dismiss_policy_enum = {
...
static const config_enum_def_t history_search_mode_enum = {
    history_search_mode_mappings, HISTORY_SEARCH_MODE_PREFIX};

/// History Finder (Ctrl-R) mappings
static const config_enum_mapping_t history_finder_match_mappings[] = {
    {    "fuzzy",     HISTORY_FINDER_MATCH_FUZZY},
    {"substring", HISTORY_FINDER_MATCH_SUBSTRING},
    {   "prefix",    HISTORY_FINDER_MATCH_PREFIX},
    {       NULL,                              0}  /// Sentinel
};
static const config_enum_def_t history_finder_match_enum = {
    history_finder_match_mappings, HISTORY_FINDER_MATCH_FUZZY};

static const config_enum_mapping_t history_finder_rank_mappings[] = {
    {"frecency", HISTORY_FINDER_RANK_FRECENCY},
    { "recency",  HISTORY_FINDER_RANK_RECENCY},
    {      NULL,                            0}  /// Sentinel
};
static const config_enum_def_t history_finder_rank_enum = {
    history_finder_rank_mappings, HISTORY_FINDER_RANK_FRECENCY};

static const config_enum_mapping_t history_finder_display_mappings[] = {
    {"incremental", HISTORY_FINDER_DISPLAY_INCREMENTAL},
    {     "picker",      HISTORY_FINDER_DISPLAY_PICKER},
    {         NULL,                                  0}  /// Sentinel
};
static const config_enum_def_t history_finder_display_enum = {
    history_finder_display_mappings, HISTORY_FINDER_DISPLAY_INCREMENTAL};
...
static config_option_t config_options[] = {
    ...
    {  "history.frecency.directory_context",   CONFIG_TYPE_BOOL,
     CONFIG_SECTION_HISTORY, &config.history_frecency_directory_context,
     "Boost frecency for commands run in the current directory",                          config_validate_bool,                         NULL          },
    ...
    {       "autosuggestion.dismiss_policy",   CONFIG_TYPE_ENUM,
...
static const creg_section_t autosuggestion_section = {
    ...
    .on_load = NULL,
    .on_save = NULL,
    .sync_to_runtime = autosuggestion_sync_to_runtime,
    .sync_from_runtime = autosuggestion_sync_from_runtime,
};
...
static void autosuggestion_sync_to_runtime(void) {
    ...
    if (config_registry_get_string("autosuggestion.dismiss_policy", sval,
                                   sizeof(sval)) == CREG_SUCCESS) {
        config.autosuggestion_dismiss_policy =
            (strcmp(sval, "on_word_boundary") == 0)
...
static void autosuggestion_sync_from_runtime(void) {
    config_registry_set_string("autosuggestion.dismiss_policy",
                               config.autosuggestion_dismiss_policy ==
                                       AUTOSUGGESTION_DISMISS_ON_WORD_BOUNDARY
                                   ? "on_word_boundary"
                                   : "on_deviation");

...
# ============================================================================
# SOURCE:           https://git.savannah.gnu.org/gitweb/?p=autoconf.git;a=blob;f=build-aux/gendocs.sh;hb=528ce663bc1b4195eba8f0cb625bc43d1b51bcb3
# UPSTREAM-COMMIT:  528ce663bc1b4195eba8f0cb625bc43d1b51bcb3
# UPSTREAM-SET:     autoconf
# LICENSE:          GPL-3.0-or-later
# BUCKET:           posix
# ADAPTED:          2026-05-31
# WAIVED:
#   - network:wget calls are gated on a CLI flag that the scorecard's --help-style invocation never triggers.
# ============================================================================
#!/bin/sh -e

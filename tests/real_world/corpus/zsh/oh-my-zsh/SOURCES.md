# Upstream sources for oh-my-zsh

Generated and maintained by tests/real_world/_harness/ingest.sh.

| Script | Upstream URL | Commit |
|--------|--------------|--------|
| clipboard.zsh | https://github.com/ohmyzsh/ohmyzsh/blob/43c6856/lib/clipboard.zsh | 43c6856 |
| spectrum.zsh | https://github.com/ohmyzsh/ohmyzsh/blob/43c6856/lib/spectrum.zsh | 43c6856 |
| theme-and-appearance.zsh | https://github.com/ohmyzsh/ohmyzsh/blob/43c6856/lib/theme-and-appearance.zsh | 43c6856 |
